...
const WhatOurClientsSay: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold text-white mb-4 flex items-center justify-center">
            <svg className="w-8 h-8 mr-3 text-indigo-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="w-full flex-shrink-0 px-4">
                  <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-8 border border-indigo-200 border-opacity-20 shadow-xl">
                    ...
                    <blockquote className="text-xl italic font-medium text-black mb-6">
                      "{testimonial.content}"
                    </blockquote>
