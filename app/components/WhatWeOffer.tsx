        ...
        {showFullDescription ? (
          <div className="animate-fadeIn">
            ...
            <button
              ...
              className="text-black hover:bg-[#FFBF23] focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center bg-[#FFBF23]"
            >
              Read Less
            </button>
          </div>
